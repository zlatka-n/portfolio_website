      ...
      <div className="bg-gray-200 py-10">
        <div className="max-w-7xl mx-auto  overflow-y-hidden min-h-screen">
          ...
          {/* <section className="mx-auto md:w-3/5 flex flex-col">
            ...
            <div className="mt-10 mb-10 px-5 md:px-0">
              ...
              <p className="text-xl mt-2 mb-5 leading-normal">
                This book store lets a user to add items to the basket. Each item (book) comes with
                its own page with description. In the basket, user can also modify quantity or
                remove items. In checkout, user must submit delivery information.
              </p>
              ...
              <p className="text-xl mt-2 mb-5 leading-normal">
                The most challenging thing I faced was configuration of the Redux store. Firstly, I
                struggled with the data structure setup and secondly, with updating the amount of an
                item, if the item was already in the basket. Also, I spent a considerable amount of
                time with website responsiveness, as it was the first time I used media queries.
              </p>
          ...
          {/* <section className="mx-auto md:w-3/5 flex flex-col">
            ...
            <div>
              <Image layout="responsive" src="/screens/typicode2.png" width={620} height={345} />
            </div>

            <div className="mt-10 mb-10 px-5 md:px-0">
              <h3 className="text-2xl text-gray-700 font-medium">Description</h3>
              <p className="text-xl mt-2 mb-5 leading-normal">
                This project fetches data from JSON Placeholder - GET request was performed. The
                data I fetched, I used for showing all posts, user search, and {" user's "} profile
                rendering. The layout of the website was inspired heavily by Facebook and Twitter.
              </p>
              <h3 className="text-2xl text-gray-700 font-medium">The main library/framework</h3>
              <ul className="text-xl mt-2 mb-5 leading-normal list-disc pl-10">
                <li>ReactJS</li>
              ...
              <h3 className="text-2xl text-gray-700 font-medium">Challenges</h3>
              <p className="text-xl mt-2 mb-5 leading-normal">
                The most difficult part for me was the user search functionality. I came up with
                setting up a hook for searched value (typed in the form input), which I later used
                for filtering the result. From Stack Overflow, I learnt how to make case insensitive
                search.
              </p>
              <div className="mt-2 mb-5 flex gap-x-3">
                <a
          ...
          {/* <section className="mx-auto md:w-3/5 flex flex-col">
            ...
            <div className="mt-10 mb-10 px-5 md:px-0">
              <h3 className="text-2xl text-gray-700 font-medium">Description</h3>
              <p className="text-xl mt-2 mb-5 leading-normal">
                This project was probably the first one that I created in Redux. The todo list is
                capable of CRUD (create, read, update, delete) operations.
              </p>
              <h3 className="text-2xl text-gray-700 font-medium">The main library/framework</h3>
              <ul className="text-xl mt-2 mb-5 leading-normal list-disc pl-10">
                <li>ReactJS</li>
              ...
              <h3 className="text-2xl text-gray-700 font-medium">Challenges</h3>
              <p className="text-xl mt-2 mb-5 leading-normal">
                The most time I spent on was the update operation. I struggled most with writing
                edit todo reducer.
              </p>
              <div className="mt-2 mb-5 flex gap-x-3">
                <a
          ...
          {/* <section className="mx-auto md:w-3/5 flex flex-col">
            ...
            <div className="px-5 md:px-0 mt-10 mb-5">
              <h3 className="text-2xl text-gray-700 font-medium">Description</h3>
              <p className="text-xl mt-2 mb-5 leading-normal">
                The reason I created this website was for job search. My potential employer can see
                my portfolio here and evaluate my tech skills.
              </p>
              <h3 className="text-2xl text-gray-700 font-medium">The main library/framework</h3>
              <ul className="text-xl mt-2 mb-5 leading-normal list-disc pl-10">
                <li>Next.js</li>
              ...
              <h3 className="text-2xl text-gray-700 font-medium">Challenges</h3>
              <p className="text-xl mt-2 leading-normal">Things that took me a while to do:</p>

              <ul className="text-xl mt-2 mb-5 leading-normal list-disc pl-10">
                <li> website layout choice</li>
                <li>
                  web responsivness for 4k {" screen's "} dimensions (3840px X 2160px) - solved with
                  custom breakpoint in Tailwind
                </li>
                <li>
                  contact page - I had to combine libraries React Hook Form and EmailJs for input
                  validation and sending a message to my email
                </li>
              </ul>
              <div className="mt-2 mb-5 flex gap-x-3">
                <a
