      ...
      <div className="flex flex-col">
        <section className="mx-auto max-w-7xl 4k:max-w-full 4k:mb-20">
          ...
          <div className="mx-auto md:w-3/5 leading-normal px-5 md:px-0 py-10 text-2xl text-gray-700">
            ...
            <p>So I made it and have been working as a front-end developer for almost a year now. :) This portfolio project is under construction, as I'm trying to refactor my spaghetti code that I created a year ago.</p>
          </div>
        </section>
